...
class Resource(metaclass=DeclarativeMetaclass):
    ...
    def save_instance(self, instance, using_transactions=True, dry_run=False, row=None, row_result=None, original=None):
        """
        ...
        """
        self.before_save_instance(instance, using_transactions, dry_run, row, row_result, original)
        if not using_transactions and dry_run:
            # we don't have transactions and we want to do a dry_run
            pass
        else:
            instance.save()
        self.after_save_instance(instance, using_transactions, dry_run, row, row_result, original)

    def before_save_instance(self, instance, using_transactions, dry_run, row, row_result, original):
        """
        Override to add additional logic. Does nothing by default.
        """
        pass

    def after_save_instance(self, instance, using_transactions, dry_run, row, row_result, original):
        """
        Override to add additional logic. Does nothing by default.
        """
        pass
